...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Add the songs
        songsArray.addAll(resources.getStringArray(R.array.Free))
        songsArray.addAll(resources.getStringArray(R.array.Ready))
        songsArray.addAll(resources.getStringArray(R.array.Bright))
